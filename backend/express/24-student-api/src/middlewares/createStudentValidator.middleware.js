...
// The createStudentValidator middleware checks if the name and rollNo and profile fields are present and valid. 
...
// The third middleware checks if the profile field is present and valid. 
